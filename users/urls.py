...
from .views import CreatePatientView, PatientSignupView, CreateStaffView, StaffLoginView, SuperadminLoginView, add_patient, check_token, get_all_patients, get_all_staff
